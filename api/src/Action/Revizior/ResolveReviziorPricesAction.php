...
/**
 * Čtení cen z ceníku dodavatele. Nic nezapisuje, takže nemá idempotency key.
 */
final class ResolveReviziorPricesAction
{
    public function __construct(
        private readonly ReviziorPriceResolver $resolver,
    ...
    public function __invoke(Request $request, Response $response, array $args): Response
    {
        ...
        try {
            ...
            $data = $this->resolver->resolve((string) ($args['organizationUuid'] ?? ''), $body);
            ...
            $this->logger->error('ReviziOR price resolution failed', [
